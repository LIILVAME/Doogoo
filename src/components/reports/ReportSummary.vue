<template>
  <div class="bg-white border border-zinc-200 rounded-2xl p-6 mt-6 shadow-sm">
    <div class="flex items-start gap-4">
      <!-- Icône -->
      <div class="flex-shrink-0">
        <div
          class="w-12 h-12 bg-emerald-50 border border-emerald-100 rounded-full flex items-center justify-center"
        >
          <svg
      ...
      <div class="flex-shrink-0 flex gap-2">
        ...
        <button
          ...
          :disabled="true"
          class="px-4 py-2.5 bg-zinc-50 border border-zinc-200 text-zinc-400 rounded-xl cursor-not-allowed text-sm font-medium flex items-center gap-2 opacity-60 hover:bg-zinc-100 transition-colors"
...
const summaryText = computed(() => {
  ...
  const endDate = formatDate(props.period.endDate, {
    day: '2-digit',
    month: '2-digit',
    year: 'numeric'
  })
