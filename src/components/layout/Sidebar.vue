<template>
  <div>
    ...
    <aside
      :class="[
        'fixed inset-y-0 left-0 z-50 w-64 md:w-20 bg-zinc-100 border-r border-zinc-300 transition-all duration-300 ease-in-out h-screen shadow-xl md:shadow-none md:relative md:translate-x-0 flex flex-col',
