    ...
    <div class="pt-24 pb-16 max-w-4xl mx-auto px-6">
      ...
      <div class="prose prose-invert max-w-none space-y-12">
        ...
        <section id="introduction">
          ...
          <div class="text-zinc-300 leading-relaxed space-y-4">
            <p>
              ...
              privée. Cette politique de confidentialité explique comment nous collectons,
              utilisons, partageons et protégeons vos données personnelles lorsque vous utilisez
              notre plateforme de gestion immobilière Doogoo (le "Service").
            </p>
            <p>
              En utilisant notre Service, vous acceptez la collecte et l'utilisation de vos
        ...
        <section id="data-usage">
          ...
          <div class="text-zinc-300 leading-relaxed space-y-4">
            ...
            <ul class="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                Vous envoyer des notifications importantes (alertes de paiement, mises à jour du
                Service)
              </li>
        ...
        <section id="legal-basis">
          ...
          <div class="text-zinc-300 leading-relaxed space-y-4">
            <p>
              Conformément au RGPD, nous traitons vos données personnelles sur les bases légales
              suivantes :
            </p>
            <ul class="list-disc list-inside space-y-2 ml-4">
              <li>
        ...
        <section id="data-sharing">
          ...
          <div class="text-zinc-300 leading-relaxed space-y-4">
            ...
            <p>
              Tous nos prestataires sont contractuellement tenus de protéger vos données et de les
              utiliser uniquement pour les fins spécifiées.
            </p>
          </div>
        </section>
        ...
        <section id="data-retention">
          ...
          <div class="text-zinc-300 leading-relaxed space-y-4">
            ...
            <ul class="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Respecter nos obligations légales (ex: conservation comptable de 10 ans)</li>
              <li>Résoudre des litiges et faire respecter nos accords</li>
            </ul>
            <p>
              Après la suppression de votre compte, vos données sont supprimées dans un délai de 30
          ...
          <div class="text-zinc-300 leading-relaxed space-y-4">
            ...
            <p>
              ...
              <a href="mailto:privacy@doogoo.app" class="text-violet-400 hover:text-violet-300"
                >privacy@doogoo.app</a
              >. Nous répondrons dans un délai de 30 jours.
            </p>
            <p>
              Vous avez également le droit de déposer une plainte auprès de la CNIL (Commission
              Nationale de l'Informatique et des Libertés) si vous estimez que vos droits ne sont
              pas respectés.
            </p>
          </div>
        </section>
        ...
        <section id="security">
          ...
          <div class="text-zinc-300 leading-relaxed space-y-4">
            ...
            <ul class="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Contrôles d'accès stricts et principe du moindre privilège</li>
        ...
        <section id="international-transfers">
          ...
          <div class="text-zinc-300 leading-relaxed space-y-4">
            <p>
              ...
              Européenne (via Supabase). Certains de nos prestataires peuvent être situés en dehors
              de l'UE.
            </p>
            <p>
              Dans ce cas, nous nous assurons que des garanties appropriées sont en place (clauses
              contractuelles types de la Commission Européenne, Privacy Shield, etc.) pour protéger
        ...
        <section id="children">
          ...
          <div class="text-zinc-300 leading-relaxed space-y-4">
            <p>
              ...
              et que vous pensez que votre enfant nous a fourni des données personnelles,
              contactez-nous pour que nous puissions les supprimer.
            </p>
          </div>
        </section>
        ...
        <section id="changes">
          ...
          <div class="text-zinc-300 leading-relaxed space-y-4">
            <p>
              ...
              dans le Service. La date de "Dernière mise à jour" en haut de cette page indique quand
              la politique a été modifiée pour la dernière fois.
            </p>
            <p>
