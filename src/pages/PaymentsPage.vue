        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div class="flex items-center gap-3">
            <button
              ...
              class="flex items-center justify-center shrink-0 bg-white border border-zinc-200 text-violet-600 hover:bg-zinc-50 hover:border-violet-200 px-4 py-2 rounded-xl font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
            >
            ...
            <button
              ...
              class="btn-primary flex items-center justify-center shrink-0 px-4 py-2 rounded-xl font-medium transition-colors shadow-sm"
            >
